    ...
    public partial class ClientObjects : ManagedObjects
    {
        ...
        internal void OnClientConnectionState(ClientConnectionStateArgs args)
        {
            ...
            if (args.ConnectionState != LocalConnectionState.Started)
            {
                ...
                if (!base.NetworkManager.IsServerInitialized)
                {
        ...
        {
            nob.RemoveObserversRpcLinkIndexes();
        ...
        internal void CacheSpawn(PooledReader reader)
        {
             ...
             * to predicted spawn. */
            if (!base.NetworkManager.IsServerInitializedOnly && base.Spawned.TryGetValue(objectId, out NetworkObject nob))
            {
