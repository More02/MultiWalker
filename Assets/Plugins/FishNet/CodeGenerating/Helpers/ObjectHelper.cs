...
namespace FishNet.CodeGenerating.Helping
{
    internal class ObjectHelper : CodegenBase
    {
        ...
        //Is checks.
        public MethodReference InstanceFinder_IsServerInitialized_MethodRef { get; private set; }
        ...
        public override bool ImportReferences()
        {
            ...
            foreach (PropertyInfo pi in instanceFinderType.GetProperties())
            {
                ...
                else if (pi.Name == nameof(InstanceFinder.IsServerInitialized))
                    InstanceFinder_IsServerInitialized_MethodRef = base.ImportReference(pi.GetMethod);
            }
