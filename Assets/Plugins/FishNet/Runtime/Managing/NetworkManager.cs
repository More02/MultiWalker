...
namespace FishNet.Managing
{
    ...
    public sealed partial class NetworkManager : MonoBehaviour
    {
        ...
        /// </summary>
        public bool IsServerInitialized => ServerManager.Started;
        /// <summary>
        ...
        /// </summary>
        public bool IsClientOnly => (!IsServerInitialized && IsClient);
        /// <summary>
        /// True if client and server are started.
        /// </summary>
        public bool IsHost => (IsServerInitialized && IsClient);
        /// <summary>
        /// True if client nor server are started.
        /// </summary>
        public bool IsOffline => (!IsServerInitialized && !IsClient);
        /// <summary>
