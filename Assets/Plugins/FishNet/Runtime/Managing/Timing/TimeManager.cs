...
namespace FishNet.Managing.Timing
{
    ...
    public sealed partial class TimeManager : MonoBehaviour
    {
        ...
        {
            get => (_networkManager.IsServerInitialized) ? Tick : _localTick;
        ...
        private void IncreaseTick()
        {
            ...
            bool IsServerInitialized = _networkManager.IsServerInitialized;

            double tickDelta = TickDelta;
            double timePerSimulation = (IsServerInitialized) ? tickDelta : _adjustedTickDelta;
            ...
            if (_allowTickDropping && !_networkManager.IsServerInitialized)
            {
