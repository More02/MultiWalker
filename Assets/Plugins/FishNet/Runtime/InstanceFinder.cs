...
namespace FishNet
{
    ...
    public static class InstanceFinder
    {
        ...
        /// </summary>
        public static bool IsServerInitialized => (NetworkManager == null) ? false : NetworkManager.IsServerInitialized;
        /// <summary>
        /// True if only the server is started.
        /// </summary>
        public static bool IsServerInitializedOnly => (NetworkManager == null) ? false : NetworkManager.IsServerInitializedOnly;
        /// <summary>
        ...
        /// </summary>
        public static bool IsOffline => (_networkManager == null) ? true : (!NetworkManager.IsServerInitialized && !NetworkManager.IsClient);
        #endregion
