...
namespace FishNet.Object
{
    ...
    public partial class NetworkObject : MonoBehaviour
    {
        ...
        private void OnDisable()
        {
            ...
            else if (IsServerInitialized && !IsNested && gameObject.activeSelf)
            {
        ...
        internal void TryStartDeactivation()
        {
            ...
            if (NetworkManager == null || (!NetworkManager.IsClient && !NetworkManager.IsServerInitialized))
            {
        ...
        /// <summary>
        /// Sets IsClient or IsServerInitialized to isActive.
        /// </summary>
        internal void SetInitializedStatus(bool isInitialized, bool asServer)
        {
            if (asServer)
                IsServerInitializedInitialized = isInitialized;
            else
                IsClientInitialized = isInitialized;
        }
        /// <summary>
        /// Sets IsServerInitializedInitialized and IsClientInitialized as false;
        /// </summary>
        private void SetDeinitializedStatus()
        {
            IsServerInitializedInitialized = false;
        ...
        internal void Preinitialize_Internal(NetworkManager networkManager, int objectId, NetworkConnection owner, bool asServer)
        {
            ...
            */
            if (!asServer && !IsServerInitialized && !IsOwner)
            {
